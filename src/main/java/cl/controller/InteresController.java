...
import cl.model.CalculaInteres;
...
public class InteresController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int numero3Int=Integer.parseInt(numero3);
        
        CalculaInteres cal=new CalculaInteres();
        
        cal.setNumero1(numero1Int);
        cal.setNumero2(numero2Int);
        cal.setNumero3(numero3Int);
        cal.multiplicar();
        cal.getMultiplica();
        
        request.setAttribute("CalculaInteres", cal);
